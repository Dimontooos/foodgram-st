...
from .views import IngredientViewSet, RecipeViewSet, ShoppingCartDownloadView, UserViewSet
...
urlpatterns = [
    ...
    path('users/me/avatar/', UserViewSet.as_view({'put': 'me_avatar', 'delete': 'me_avatar'}), name='user-avatar'),
